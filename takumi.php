            ...
            <div class="row align-items-center">
                <div class="col-lg-2 col-8">
                    <div class="main-brand-wrap d-flex align-items-center justify-content-between">
                        ...
                        <a class="main-logo" href="#"><img alt="logo" src="images/logo-black.png"></a>
                        <!-- end side-menu-open -->
            ...
            <div class="col-lg-7">
                <div class="product-details mt-lg-5 pt-lg-5 mt-0 pt-0">
                    ...
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <a class="btn btn-primary mr-4" href="https://app.octopus.com.hk/qrpayment?token=OEM03056391304011110635000012033444904037B">Octopus</a>
                    </div>
