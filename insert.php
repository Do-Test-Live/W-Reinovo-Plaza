...
if (isset($_POST["pay_now"])) {
    ...
    $schedule = $db_handle->checkValue($_POST['schedule']);
    $heart_problem = $db_handle->checkValue($_POST['heart_problem']);
    $chest_pain_physical_activity = $db_handle->checkValue($_POST['chest_pain_physical_activity']);
    $chest_pain_not_physical_activity = $db_handle->checkValue($_POST['chest_pain_not_physical_activity']);
    $felt_dizzy = $db_handle->checkValue($_POST['felt_dizzy']);
    $joint_problem = $db_handle->checkValue($_POST['joint_problem']);
    $blood_pressure = $db_handle->checkValue($_POST['blood_pressure']);
    $other_reason = $db_handle->checkValue($_POST['other_reason']);
